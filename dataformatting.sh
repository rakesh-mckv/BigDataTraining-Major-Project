...
hadoop fs -put /home/acadgild/project/web/* /user/acadgild/project/batch${batchid}/web/
hadoop fs -put /home/acadgild/project/mob/* /user/acadgild/project/batch${batchid}/mob/

echo "Running pig script for data formatting..." >> $LOGFILE

pig -f /home/acadgild/project/scripts/dataformatting.pig --param batchid=$batchid
